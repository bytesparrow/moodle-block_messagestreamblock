<?php
$string['pluginname'] = 'Nachrichtenstream';
$string['messagestreamblock:addinstance'] = 'Einen neuen Nachrichtenstream-Block hinzufügen';
$string['helloworld'] = 'Hallo Welt aus JavaScript!';
$string['configtitle'] = 'Blocktitel';
$string['askquestion'] = "Stell' eine Frage";
$string['popupheader'] = 'Frage stellen';
$string['config_blockatfirstposition'] = 'Diesen Block vor dem Buchinhaltsverzeichnis zeigen';
$string['config_blockshowheader'] = 'Blocktitel anzeigen';
$string['config_buttonlabel'] = 'Beschriftung des Frage-Buttons';
$string['config_textbeforestream'] = 'Text vor dem Stream';
